...
export const PricingCard = ({
  ...
  type,
  className,
  checkCheck = "https://c.animaapp.com/mh4off2oUskXoJ/img/checkmark-9.svg",
  text = "Up to 5 project members",
  checkImg = "https://c.animaapp.com/mh4off2oUskXoJ/img/checkmark-9.svg",
  text1 = "Unlimited tasks and projects",
  checkCheck1 = "https://c.animaapp.com/mh4off2oUskXoJ/img/checkmark-9.svg",
  text2 = "2GB storage",
  checkCheck2 = "https://c.animaapp.com/mh4off2oUskXoJ/img/checkmark-9.svg",
  text3 = "Integrations",
  checkCheck3 = "https://c.animaapp.com/mh4off2oUskXoJ/img/checkmark-9.svg",
  text4 = "Basic support",
              ...
              <>
                {showBadge && (
                  <Badge
                    ...
                    inputIconsPropertyZapSize="https://c.animaapp.com/mh4off2oUskXoJ/img/input-icons-7.svg"
                    label="Most Popular"
                    state="default"
                  />
                )}
